...
The 'ecb_forex_data' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] ecb_forex_data_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/ecb_forex_data.job.yml). The schedule
